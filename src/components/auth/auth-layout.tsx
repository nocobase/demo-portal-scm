      ...
      <section className="relative hidden overflow-hidden bg-neutral-950 p-12 text-white md:grid md:place-items-center">
        ...
        <div className="relative w-full max-w-xl">
          <div className="text-xs font-semibold uppercase tracking-[0.14em] text-primary-foreground/60">
            {translate("auth.brand.platform", "AI-native application platform")}
          </div>
          <h2 className="mt-3 max-w-lg text-5xl font-semibold leading-[1.08] tracking-[-0.04em]">
            {translate("auth.brand.headline", "Let AI build freely. NocoBase keeps it reliable.")}
          </h2>
          ...
          <div className="mt-10 max-w-md rounded-xl border border-white/15 bg-white p-5 text-neutral-900 shadow-2xl shadow-black/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">
                  {translate("auth.brand.frontendTitle", "AI-native frontend")}
                </div>
                <div className="text-sm text-neutral-500">
                  {translate("auth.brand.frontendBody", "Compose interfaces freely on a flexible framework.")}
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-semibold">
                  {translate("auth.brand.foundationTitle", "NocoBase foundation")}
                </div>
                <div className="text-sm text-neutral-500">
                  {translate("auth.brand.foundationBody", "Reliable data, access control, workflows and governance.")}
                </div>
              </div>
            </div>
            <div className="mt-5 flex items-center gap-2 rounded-lg bg-neutral-100 px-3 py-2 text-xs font-medium text-neutral-600">
              <Blocks className="size-3.5" />
              {translate("auth.brand.tagline", "Freedom above. Confidence below.")}
            </div>
          </div>
        </div>
      </section>
